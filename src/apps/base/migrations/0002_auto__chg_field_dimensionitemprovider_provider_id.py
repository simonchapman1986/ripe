...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DimensionItemProvider.provider_id'
        db.alter_column('dim_item_provider', 'provider_id', self.gf('django.db.models.fields.CharField')(max_length=128L, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'DimensionItemProvider.provider_id'
        db.alter_column('dim_item_provider', 'provider_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))
