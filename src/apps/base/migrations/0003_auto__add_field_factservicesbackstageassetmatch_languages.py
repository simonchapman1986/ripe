...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FactServicesBackstageAssetMatch.languages'
        db.add_column('fact_services_backstage_asset_match', 'languages',
    ...
    def backwards(self, orm):
        # Deleting field 'FactServicesBackstageAssetMatch.languages'
        db.delete_column('fact_services_backstage_asset_match', 'languages')
