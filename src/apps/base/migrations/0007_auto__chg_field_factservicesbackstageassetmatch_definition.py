...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FactServicesBackstageAssetMatch.definition'
        db.alter_column('fact_services_backstage_asset_match', 'definition_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionDefinition'], null=True))

    def backwards(self, orm):

        # Changing field 'FactServicesBackstageAssetMatch.definition'
        db.alter_column('fact_services_backstage_asset_match', 'definition_id', self.gf('django.db.models.fields.related.ForeignKey')(default='HD', to=orm['base.DimensionDefinition']))
