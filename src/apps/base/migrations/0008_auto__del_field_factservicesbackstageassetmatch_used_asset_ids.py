...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FactServicesBackstageAssetMatch.used_asset_ids'
        db.delete_column('fact_services_backstage_asset_match', 'used_asset_ids')

        # Adding M2M table for field used_asset_ids on 'FactServicesBackstageAssetMatch'
        m2m_table_name = db.shorten_name('fact_services_backstage_asset_match_used_asset_ids')
        ...
        db.create_unique(m2m_table_name, ['factservicesbackstageassetmatch_id', 'dimensionassets_id'])


    def backwards(self, orm):
        # Adding field 'FactServicesBackstageAssetMatch.used_asset_ids'
        db.add_column('fact_services_backstage_asset_match', 'used_asset_ids',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field used_asset_ids on 'FactServicesBackstageAssetMatch'
        db.delete_table(db.shorten_name('fact_services_backstage_asset_match_used_asset_ids'))
    ...
    models = {
        ...
        'base.factservicesbackstageassetmatch': {
            ...
            'languages': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'last_modified_utc': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
