...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DimensionDefinition.definition'
        db.alter_column('dim_definition', 'definition', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'DimensionDefinition.definition'
        db.alter_column('dim_definition', 'definition', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
