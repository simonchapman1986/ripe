...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FactServicesLicensingDelivery'
        db.create_table('fact_services_licensing_delivery', (
        ...
        db.send_create_signal('base', ['FactServicesLicensingDelivery'])


    def backwards(self, orm):
        # Deleting model 'FactServicesLicensingDelivery'
        db.delete_table('fact_services_licensing_delivery')
