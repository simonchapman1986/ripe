...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FactServicesStorefrontTransaction.last_4_digits'
        db.add_column('fact_services_storefront_transaction', 'last_4_digits',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FactServicesStorefrontTransaction.last_4_digits'
        db.delete_column('fact_services_storefront_transaction', 'last_4_digits')
