...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DimensionUser.first_name'
        db.add_column('dim_user', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DimensionUser.last_name'
        db.add_column('dim_user', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DimensionUser.marketing_preference'
        db.add_column('dim_user', 'marketing_preference',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DimensionUser.country_of_residence'
        db.add_column('dim_user', 'country_of_residence',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FactServicesStorefrontRegistration.account'
        db.add_column('fact_services_storefront_registrations', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['base.DimensionAccount']),
                      keep_default=False)

        # Adding field 'DimensionAccount.account_created'
        db.add_column('dim_account', 'account_created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'DimensionAccount.account_id'
        db.alter_column('dim_account', 'account_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        ...
        # Changing field 'DimensionDevice.make'
        db.alter_column('dim_device', 'make', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DimensionDevice.os_version'
        db.alter_column('dim_device', 'os_version', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DimensionDevice.model'
        db.alter_column('dim_device', 'model', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DimensionDevice.os'
        db.alter_column('dim_device', 'os', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'DimensionUser.first_name'
        db.delete_column('dim_user', 'first_name')

        # Deleting field 'DimensionUser.last_name'
        db.delete_column('dim_user', 'last_name')

        # Deleting field 'DimensionUser.marketing_preference'
        db.delete_column('dim_user', 'marketing_preference')

        # Deleting field 'DimensionUser.country_of_residence'
        db.delete_column('dim_user', 'country_of_residence')

        # Deleting field 'FactServicesStorefrontRegistration.account'
        db.delete_column('fact_services_storefront_registrations', 'account_id')

        # Deleting field 'DimensionAccount.account_created'
        db.delete_column('dim_account', 'account_created')


        # Changing field 'DimensionAccount.account_id'
        db.alter_column('dim_account', 'account_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
        ...
        # Changing field 'DimensionDevice.make'
        db.alter_column('dim_device', 'make', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'DimensionDevice.os_version'
        db.alter_column('dim_device', 'os_version', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'DimensionDevice.model'
        db.alter_column('dim_device', 'model', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'DimensionDevice.os'
        db.alter_column('dim_device', 'os', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    models = {
        ...
        'base.dimensiondevice': {
            ...
            'device_mcc': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '3', 'null': 'True', 'blank': 'True'}),
            'device_mnc': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '3', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
