...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FactServicesStorefrontTransaction.right'
        db.alter_column('fact_services_storefront_transaction', 'right_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionRight'], null=True))

        # Changing field 'FactServicesStorefrontTransaction.currency'
        db.alter_column('fact_services_storefront_transaction', 'currency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionCurrency'], null=True))

        # Changing field 'FactServicesStorefrontTransaction.transaction_status'
        db.alter_column('fact_services_storefront_transaction', 'transaction_status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionStoreTransactionStatus'], null=True))

        # Changing field 'FactServicesStorefrontTransaction.retail_model'
        db.alter_column('fact_services_storefront_transaction', 'retail_model_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionRetailModel'], null=True))

        # Changing field 'FactServicesStorefrontTransaction.platform'
        db.alter_column('fact_services_storefront_transaction', 'platform_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionPlatform'], null=True))

        # Changing field 'FactServicesStorefrontTransaction.window'
        db.alter_column('fact_services_storefront_transaction', 'window_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionWindow'], null=True))

        # Changing field 'FactServicesStorefrontTransaction.territory'
        db.alter_column('fact_services_storefront_transaction', 'territory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionTerritory'], null=True))

        # Changing field 'FactServicesStorefrontTransaction.product'
        db.alter_column('fact_services_storefront_transaction', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionProduct'], null=True))

        # Changing field 'FactServicesStorefrontTransaction.user'
        db.alter_column('fact_services_storefront_transaction', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionUser'], null=True))

        # Changing field 'FactServicesStorefrontTransaction.device'
        db.alter_column('fact_services_storefront_transaction', 'device_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionDevice'], null=True))

        # Changing field 'FactServicesStorefrontTransaction.definition'
        db.alter_column('fact_services_storefront_transaction', 'definition_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionDefinition'], null=True))

        # Changing field 'FactServicesStorefrontTransaction.account'
        db.alter_column('fact_services_storefront_transaction', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionAccount'], null=True))

        # Changing field 'FactServicesStorefrontTransaction.item'
        db.alter_column('fact_services_storefront_transaction', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionItem'], null=True))

        # Changing field 'FactServicesStorefrontTransaction.client'
        db.alter_column('fact_services_storefront_transaction', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionClient'], null=True))

        # Changing field 'DimensionUser.client'
        db.alter_column('dim_user', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionClient'], null=True))

        # Changing field 'DimensionUser.territory'
        db.alter_column('dim_user', 'territory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionTerritory'], null=True))
        # Deleting field 'DimensionWindow.product_id'
        db.delete_column('dim_window', 'product_id')

        # Deleting field 'DimensionWindow.item_id'
        db.delete_column('dim_window', 'item_id')

        # Deleting field 'DimensionWindow.usage_right_id'
        db.delete_column('dim_window', 'usage_right_id')

        # Adding field 'DimensionWindow.item'
        db.add_column('dim_window', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionItem'], null=True),
                      keep_default=False)

        # Adding field 'DimensionWindow.product'
        db.add_column('dim_window', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionProduct'], null=True),
                      keep_default=False)

        # Adding field 'DimensionWindow.usage_right'
        db.add_column('dim_window', 'usage_right',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionRight'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'FactServicesStorefrontTransaction.right'
        db.alter_column('fact_services_storefront_transaction', 'right_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionRight']))

        # Changing field 'FactServicesStorefrontTransaction.currency'
        db.alter_column('fact_services_storefront_transaction', 'currency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionCurrency']))

        # Changing field 'FactServicesStorefrontTransaction.transaction_status'
        db.alter_column('fact_services_storefront_transaction', 'transaction_status_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['base.DimensionStoreTransactionStatus']))

        # Changing field 'FactServicesStorefrontTransaction.retail_model'
        db.alter_column('fact_services_storefront_transaction', 'retail_model_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionRetailModel']))

        # Changing field 'FactServicesStorefrontTransaction.platform'
        db.alter_column('fact_services_storefront_transaction', 'platform_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionPlatform']))

        # Changing field 'FactServicesStorefrontTransaction.window'
        db.alter_column('fact_services_storefront_transaction', 'window_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionWindow']))

        # Changing field 'FactServicesStorefrontTransaction.territory'
        db.alter_column('fact_services_storefront_transaction', 'territory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionTerritory']))

        # Changing field 'FactServicesStorefrontTransaction.product'
        db.alter_column('fact_services_storefront_transaction', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionProduct']))

        # Changing field 'FactServicesStorefrontTransaction.user'
        db.alter_column('fact_services_storefront_transaction', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionUser']))

        # Changing field 'FactServicesStorefrontTransaction.device'
        db.alter_column('fact_services_storefront_transaction', 'device_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionDevice']))

        # Changing field 'FactServicesStorefrontTransaction.definition'
        db.alter_column('fact_services_storefront_transaction', 'definition_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionDefinition']))

        # Changing field 'FactServicesStorefrontTransaction.account'
        db.alter_column('fact_services_storefront_transaction', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionAccount']))

        # Changing field 'FactServicesStorefrontTransaction.item'
        db.alter_column('fact_services_storefront_transaction', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionItem']))

        # Changing field 'FactServicesStorefrontTransaction.client'
        db.alter_column('fact_services_storefront_transaction', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionClient']))

        # Changing field 'DimensionUser.client'
        db.alter_column('dim_user', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionClient']))

        # Changing field 'DimensionUser.territory'
        db.alter_column('dim_user', 'territory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionTerritory']))
        # Adding field 'DimensionWindow.product_id'
        db.add_column('dim_window', 'product_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'DimensionWindow.item_id'
        db.add_column('dim_window', 'item_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'DimensionWindow.usage_right_id'
        db.add_column('dim_window', 'usage_right_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Deleting field 'DimensionWindow.item'
        db.delete_column('dim_window', 'item_id')

        # Deleting field 'DimensionWindow.product'
        db.delete_column('dim_window', 'product_id')

        # Deleting field 'DimensionWindow.usage_right'
        db.delete_column('dim_window', 'usage_right_id')
    ...
    models = {
        ...
        'base.dimensionuser': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionClient']", 'null': 'True'}),
            ...
            'territory': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionTerritory']", 'null': 'True'})
        },
        ...
        'base.dimensionwindow': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionItem']", 'null': 'True'}),
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionProduct']", 'null': 'True'}),
            ...
            'usage_right': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionRight']", 'null': 'True'}),
        ...
        'base.factservicesstorefronttransaction': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionAccount']", 'null': 'True'}),
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionClient']", 'null': 'True'}),
            'currency': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionCurrency']", 'null': 'True'}),
            'definition': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionDefinition']", 'null': 'True'}),
            'device': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionDevice']", 'null': 'True'}),
            'event_utc_date': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionUTCDate']", 'null': 'True'}),
            'event_utc_datetime': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionItem']", 'null': 'True'}),
            ...
            'mcc': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'mnc': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'platform': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionPlatform']", 'null': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionProduct']", 'null': 'True'}),
            'retail_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionRetailModel']", 'null': 'True'}),
            'right': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionRight']", 'null': 'True'}),
            'territory': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionTerritory']", 'null': 'True'}),
            'transaction_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
            'transaction_status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionStoreTransactionStatus']", 'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionUser']", 'null': 'True'}),
            'window': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionWindow']", 'null': 'True'})
        },
        'base.service': {
