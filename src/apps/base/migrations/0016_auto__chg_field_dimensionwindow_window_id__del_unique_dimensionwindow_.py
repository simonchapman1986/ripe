...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DimensionWindow', fields ['window_id']
        db.delete_unique('dim_window', ['window_id'])


        # Changing field 'DimensionWindow.window_id'
        db.alter_column('dim_window', 'window_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'DimensionWindow.window_id'
        db.alter_column('dim_window', 'window_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255, unique=True))
        # Adding unique constraint on 'DimensionWindow', fields ['window_id']
        db.create_unique('dim_window', ['window_id'])
