...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FactServicesStorefrontSubscription.subscription_type'
        db.alter_column('fact_services_storefront_subscriptions', 'subscription_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionSubscriptionType'], null=True))

        # Changing field 'FactServicesStorefrontSubscription.platform'
        db.alter_column('fact_services_storefront_subscriptions', 'platform_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionPlatform'], null=True))

        # Changing field 'FactServicesStorefrontSubscription.window'
        db.alter_column('fact_services_storefront_subscriptions', 'window_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionWindow'], null=True))

        # Changing field 'FactServicesStorefrontSubscription.event_utc_datetime'
        db.alter_column('fact_services_storefront_subscriptions', 'event_utc_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'FactServicesStorefrontSubscription.user'
        db.alter_column('fact_services_storefront_subscriptions', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionUser'], null=True))

        # Changing field 'FactServicesStorefrontSubscription.subscription_status'
        db.alter_column('fact_services_storefront_subscriptions', 'subscription_status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionSubscriptionStatus'], null=True))

        # Changing field 'FactServicesStorefrontSubscription.event_utc_date'
        db.alter_column('fact_services_storefront_subscriptions', 'event_utc_date_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionUTCDate'], null=True))

        # Changing field 'FactServicesStorefrontSubscription.subscription_id'
        db.alter_column('fact_services_storefront_subscriptions', 'subscription_id', self.gf('django.db.models.fields.CharField')(max_length=36, null=True))

        # Changing field 'FactServicesStorefrontSubscription.subscription_state'
        db.alter_column('fact_services_storefront_subscriptions', 'subscription_state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionSubscriptionState'], null=True))

    def backwards(self, orm):

        # Changing field 'FactServicesStorefrontSubscription.subscription_type'
        db.alter_column('fact_services_storefront_subscriptions', 'subscription_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionSubscriptionType']))

        # Changing field 'FactServicesStorefrontSubscription.platform'
        db.alter_column('fact_services_storefront_subscriptions', 'platform_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionPlatform']))

        # Changing field 'FactServicesStorefrontSubscription.window'
        db.alter_column('fact_services_storefront_subscriptions', 'window_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionWindow']))

        # Changing field 'FactServicesStorefrontSubscription.event_utc_datetime'
        db.alter_column('fact_services_storefront_subscriptions', 'event_utc_datetime', self.gf('django.db.models.fields.DateTimeField')(default=''))

        # Changing field 'FactServicesStorefrontSubscription.user'
        db.alter_column('fact_services_storefront_subscriptions', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionUser']))

        # Changing field 'FactServicesStorefrontSubscription.subscription_status'
        db.alter_column('fact_services_storefront_subscriptions', 'subscription_status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionSubscriptionStatus']))

        # Changing field 'FactServicesStorefrontSubscription.event_utc_date'
        db.alter_column('fact_services_storefront_subscriptions', 'event_utc_date_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['base.DimensionUTCDate']))

        # Changing field 'FactServicesStorefrontSubscription.subscription_id'
        db.alter_column('fact_services_storefront_subscriptions', 'subscription_id', self.gf('django.db.models.fields.CharField')(default='', max_length=36))

        # Changing field 'FactServicesStorefrontSubscription.subscription_state'
        db.alter_column('fact_services_storefront_subscriptions', 'subscription_state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.DimensionSubscriptionState']))
    ...
    models = {
        ...
        'base.dimensionwindow': {
            ...
            'window_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
        ...
        'base.factservicesstorefrontsubscription': {
            ...
            'event_utc_date': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['base.DimensionUTCDate']", 'null': 'True'}),
            'event_utc_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified_utc': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'platform': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['base.DimensionPlatform']", 'null': 'True'}),
            'subscription_id': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '36', 'null': 'True', 'blank': 'True'}),
            'subscription_state': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['base.DimensionSubscriptionState']", 'null': 'True'}),
            'subscription_state_error': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'subscription_status': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['base.DimensionSubscriptionStatus']", 'null': 'True'}),
            'subscription_type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['base.DimensionSubscriptionType']", 'null': 'True'}),
            'transaction_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['base.DimensionUser']", 'null': 'True'}),
            'window': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['base.DimensionWindow']", 'null': 'True'})
        },
