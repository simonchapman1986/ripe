...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DimensionSubscriptionType.recurrence'
        db.alter_column('dim_subscription_type', 'recurrence', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DimensionSubscriptionType.period'
        db.alter_column('dim_subscription_type', 'period', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

    def backwards(self, orm):

        # Changing field 'DimensionSubscriptionType.recurrence'
        db.alter_column('dim_subscription_type', 'recurrence', self.gf('django.db.models.fields.IntegerField')(default=''))

        # Changing field 'DimensionSubscriptionType.period'
        db.alter_column('dim_subscription_type', 'period', self.gf('django.db.models.fields.CharField')(default='', max_length=25))
