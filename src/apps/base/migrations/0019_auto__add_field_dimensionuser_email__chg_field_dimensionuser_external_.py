...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DimensionPlatform.version'
        db.alter_column('dim_platform', 'version', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DimensionPlatform.os'
        db.alter_column('dim_platform', 'os', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DimensionPlatform.name'
        db.alter_column('dim_platform', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Changing field 'DimensionPlatform.version'
        db.alter_column('dim_platform', 'version', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'DimensionPlatform.os'
        db.alter_column('dim_platform', 'os', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'DimensionPlatform.name'
        db.alter_column('dim_platform', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
