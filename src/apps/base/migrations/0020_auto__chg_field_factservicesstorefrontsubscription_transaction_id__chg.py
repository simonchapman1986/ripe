...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FactServicesStorefrontSubscription.transaction_id'
        db.alter_column('fact_services_storefront_subscriptions', 'transaction_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'FactServicesStorefrontTransaction.event_utc_datetime'
        db.alter_column('fact_services_storefront_transaction', 'event_utc_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'FactServicesStorefrontTransaction.transaction_id'
        db.alter_column('fact_services_storefront_transaction', 'transaction_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'FactServicesStorefrontSubscription.transaction_id'
        db.alter_column('fact_services_storefront_subscriptions', 'transaction_id', self.gf('django.db.models.fields.CharField')(max_length=255))

        # User chose to not deal with backwards NULL issues for 'FactServicesStorefrontTransaction.event_utc_datetime'
        raise RuntimeError("Cannot reverse this migration. 'FactServicesStorefrontTransaction.event_utc_datetime' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FactServicesStorefrontTransaction.event_utc_datetime'
        db.alter_column('fact_services_storefront_transaction', 'event_utc_datetime', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'FactServicesStorefrontTransaction.transaction_id'
        db.alter_column('fact_services_storefront_transaction', 'transaction_id', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'base.dimensionsubscriptiontype': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'period': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '25', 'null': 'True'}),
            'recurrence': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True'})
        },
        ...
        'base.dimensionuser': {
            ...
            'external_user_id': ('django.db.models.fields.CharField', [], {'default': "'00000000-0000-0000-0000-000000000000'", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'internal_user_id': ('django.db.models.fields.CharField', [], {'default': "'00000000-0000-0000-0000-000000000000'", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
        ...
        'base.factservicesstorefrontsubscription': {
            ...
            'transaction_id': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'null': 'True'}),
        ...
        'base.factservicesstorefronttransaction': {
            ...
            'event_utc_date': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionUTCDate']", 'null': 'True'}),
            'event_utc_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.DimensionItem']", 'null': 'True'}),
