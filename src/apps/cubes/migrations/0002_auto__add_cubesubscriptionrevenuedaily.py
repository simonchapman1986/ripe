...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CubeSubscriptionRevenueDaily'
        db.create_table('summary_subscription_revenue_daily', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 18, 0, 0), auto_now=True, blank=True)),
        ...
        db.send_create_signal('cubes', ['CubeSubscriptionRevenueDaily'])


    def backwards(self, orm):
        # Deleting model 'CubeSubscriptionRevenueDaily'
        db.delete_table('summary_subscription_revenue_daily')
