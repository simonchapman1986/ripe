...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CubeAssetMatch'
        db.create_table('summary_asset_match_daily', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 23, 0, 0), auto_now=True, blank=True)),
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('client_id', self.gf('django.db.models.fields.CharField')(max_length=36)),
            ('client_name', self.gf('django.db.models.fields.CharField')(max_length=36)),
            ...
            ('item_content_type', self.gf('django.db.models.fields.CharField')(max_length=30L, null=True, blank=True)),
            ('item_title', self.gf('django.db.models.fields.CharField')(max_length=255L, null=True, blank=True)),
            ('item_release_year', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('item_last_modified', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('asset_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('asset_type', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('data_role', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('processing_state', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('used_asset_ids', self.gf('django.db.models.fields.TextField')()),
            ('item_provider_id', self.gf('django.db.models.fields.CharField')(max_length=128L, null=True, blank=True)),
            ('item_provider_name', self.gf('django.db.models.fields.CharField')(max_length=128L, null=True, blank=True)),
            ('definition', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('languages_iso_code', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal('cubes', ['CubeAssetMatch'])


    def backwards(self, orm):
        # Deleting model 'CubeAssetMatch'
        db.delete_table('summary_asset_match_daily')
    ...
    models = {
        'cubes.cubeassetmatch': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 23, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
