...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CubeSubscriptionRevenueDaily.transaction_id'
        db.add_column('summary_subscription_revenue_daily', 'transaction_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CubeSubscriptionRevenueDaily.transaction_id'
        db.delete_column('summary_subscription_revenue_daily', 'transaction_id')
    ...
    models = {
        'cubes.cubeassetmatch': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 26, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
