...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CubeRegistrationRawDaily'
        db.create_table('summary_registration_raw_daily', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 1, 0, 0), auto_now=True, blank=True)),
            ...
            ('client_name', self.gf('django.db.models.fields.CharField')(default='', max_length=36)),
        ...
        db.send_create_signal('cubes', ['CubeRegistrationRawDaily'])


    def backwards(self, orm):
        # Deleting model 'CubeRegistrationRawDaily'
        db.delete_table('summary_registration_raw_daily')
    ...
    models = {
        'cubes.cubeassetmatch': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 1, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
