...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CubeStoreTransaction.client_name'
        db.add_column('summary_storetransaction_daily', 'client_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CubeStoreTransaction.client_name'
        db.delete_column('summary_storetransaction_daily', 'client_name')
