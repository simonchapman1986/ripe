...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CubeLicenseDeliveryRawDaily.client_name'
        db.add_column('summary_license_delivery_raw_daily', 'client_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CubeLicenseDeliveryRawDaily.client_name'
        db.delete_column('summary_license_delivery_raw_daily', 'client_name')
    ...
    models = {
        'cubes.cubeassetmatch': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 30, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
