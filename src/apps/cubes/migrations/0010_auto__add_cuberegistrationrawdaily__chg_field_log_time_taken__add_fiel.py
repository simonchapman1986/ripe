...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'Log.time_taken'
        db.alter_column('log', 'time_taken', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))


    def backwards(self, orm):
        # Changing field 'Log.time_taken'
        db.alter_column('log', 'time_taken', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=6))
    ...
    models = {
        'cubes.cubeassetmatch': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
